...
theorem chunk6_generated_eq :
    buildEndpointTree 2 8 6 13
      ((((((((lrGapBudgetSETailRoot).lower .s (1/100)).lower .s (1/1000)).lower .s (1/10000)).upper .s (1/100000)).upper .k (1/2)).lower .chi (1/2)).upper .k (3/4)) = some chunk6 := by
  rfl'

theorem chunk6_check :
    chunk6.check
      (LRGapBudgetSEDerivativeAcceptData.check 2 8 6)
      lrGapBudgetSEDiscardCheck ((((((((lrGapBudgetSETailRoot).lower .s (1/100)).lower .s (1/1000)).lower .s (1/10000)).upper .s (1/100000)).upper .k (1/2)).lower .chi (1/2)).upper .k (3/4)) = true :=
  buildEndpointTree_check_of_eq 2 8 6 13 ((((((((lrGapBudgetSETailRoot).lower .s (1/100)).lower .s (1/1000)).lower .s (1/10000)).upper .s (1/100000)).upper .k (1/2)).lower .chi (1/2)).upper .k (3/4)) chunk6 chunk6_generated_eq
