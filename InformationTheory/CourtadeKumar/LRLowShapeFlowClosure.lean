import InformationTheory.CourtadeKumar.LRLowShapeVComplete

/-! Differential closure of the complete low-shape target-root flow. -/

open Set

namespace CourtadeKumar

theorem hasDerivAt_lrReserve_exactFlow_lowShape
  ...
  have hnumP := lrFlowNumeratorP_nonneg_target_lowShape hR
