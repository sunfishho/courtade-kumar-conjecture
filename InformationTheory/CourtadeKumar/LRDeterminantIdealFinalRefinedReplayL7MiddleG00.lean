...
theorem chunk000_checked :
    packedCheck (middleAutoOracle lowTerms lowLogFuel)
      (follow middleRoot chunk000Path) chunk000Packed = true := by
  rfl'

noncomputable def chunk000 :
    CheckedChunk (middleAutoOracle lowTerms lowLogFuel)
      (follow middleRoot chunk000Path) :=
...
theorem chunk001_checked :
    packedCheck (middleAutoOracle lowTerms lowLogFuel)
      (follow middleRoot chunk001Path) chunk001Packed = true := by
  rfl'

noncomputable def chunk001 :
    CheckedChunk (middleAutoOracle lowTerms lowLogFuel)
      (follow middleRoot chunk001Path) :=
  PackedCheckedChunk.toCheckedChunk
...
theorem chunk002_checked :
    packedCheck (middleAutoOracle lowTerms lowLogFuel)
      (follow middleRoot chunk002Path) chunk002Packed = true := by
  rfl'

noncomputable def chunk002 :
    CheckedChunk (middleAutoOracle lowTerms lowLogFuel)
      (follow middleRoot chunk002Path) :=
  PackedCheckedChunk.toCheckedChunk
...
theorem chunk003_checked :
    packedCheck (middleAutoOracle lowTerms lowLogFuel)
      (follow middleRoot chunk003Path) chunk003Packed = true := by
  rfl'

noncomputable def chunk003 :
    CheckedChunk (middleAutoOracle lowTerms lowLogFuel)
      (follow middleRoot chunk003Path) :=
  PackedCheckedChunk.toCheckedChunk
