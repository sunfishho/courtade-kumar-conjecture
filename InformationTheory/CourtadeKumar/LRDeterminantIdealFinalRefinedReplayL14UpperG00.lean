...
theorem chunk000_checked :
    packedCheck (restrictedAutoOracle restrictedTerms restrictedLogFuel)
      (follow restrictedUpperRoot chunk000Path) chunk000Packed = true := by
  rfl'

noncomputable def chunk000 :
    CheckedChunk (restrictedAutoOracle restrictedTerms restrictedLogFuel)
      (follow restrictedUpperRoot chunk000Path) :=
...
theorem chunk001_checked :
    packedCheck (restrictedAutoOracle restrictedTerms restrictedLogFuel)
      (follow restrictedUpperRoot chunk001Path) chunk001Packed = true := by
  rfl'

noncomputable def chunk001 :
    CheckedChunk (restrictedAutoOracle restrictedTerms restrictedLogFuel)
      (follow restrictedUpperRoot chunk001Path) :=
  PackedCheckedChunk.toCheckedChunk
...
theorem chunk002_checked :
    packedCheck (restrictedAutoOracle restrictedTerms restrictedLogFuel)
      (follow restrictedUpperRoot chunk002Path) chunk002Packed = true := by
  rfl'

noncomputable def chunk002 :
    CheckedChunk (restrictedAutoOracle restrictedTerms restrictedLogFuel)
      (follow restrictedUpperRoot chunk002Path) :=
  PackedCheckedChunk.toCheckedChunk
...
theorem chunk003_checked :
    packedCheck (restrictedAutoOracle restrictedTerms restrictedLogFuel)
      (follow restrictedUpperRoot chunk003Path) chunk003Packed = true := by
  rfl'

noncomputable def chunk003 :
    CheckedChunk (restrictedAutoOracle restrictedTerms restrictedLogFuel)
      (follow restrictedUpperRoot chunk003Path) :=
  PackedCheckedChunk.toCheckedChunk
