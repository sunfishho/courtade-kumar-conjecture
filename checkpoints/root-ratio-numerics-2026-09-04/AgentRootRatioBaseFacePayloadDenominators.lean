...
#kernel_checked_bool denominatorsChecked ((pilotPayload 8).payloadDenominatorCheck (pilotBox 8))

#print axioms CourtadeKumar.RootRatioBaseFacePayloadReceipts.denominatorsChecked
